...
import com.xp.mymvp.Tool.Util.CheckPermission;
import com.xp.mymvp.Tool.View.MyToast;

/**
 * Created by xp on 2016/5/18.
 * 用户权限获取页面，权限处理
 */
...
public class PermissionActivity extends Activity {
    ...
    private static final String EXTRA_PERMISSION = "com.xp.permission";//权限参数
    ...
    private void showMissingPermissionDialog() {
        MyToast.showToast(this, "当前应用缺少必要权限。\\n\\n请点击\\\"设置\\\"-\\\"权限\\\"-打开所需权限。");
